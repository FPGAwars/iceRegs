{
  "version": "1.2",
  "package": {
    "name": "SregR-rst-02-verilog",
    "version": "0.2",
    "description": "SregR-rst-02-verilog: Two bits Shift register to the right, with reset. Verilog implementation",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "fc569c2c-a69a-4607-b59e-ac957720189d",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "0",
        ...
        {
          "id": "60d4c187-7512-41f9-bec7-85e3cc3264cb",
          "type": "basic.code",
          "data": {
            "ports": {
              "in": [
            ...
            "code": "//-- Generic Shift register to the right\n//-- With reset\n\n//-- Number of bits\nlocalparam N = 2;\n\n//-- Initial value\nreg [N-1:0] q = INI;\n\n//-- Serial out: lsb\nassign so = q[0];\n\nalways @(posedge clk)\nbegin\n \n  //-- Reset: Load initial value\n  if (rst == 1'b1)\n    q <= INI;\n    \n  //-- Shift right only if shift is 1\n  else if (shift == 1'b1)\n    q <= {si, q[1]};\n  \n  //-- Remains unchanged in any other case\n  \nend\n"
          },
          "position": {
            "x": 328,
            "y": -128
      ...
      "wires": [
        {
          "source": {
            "block": "fc569c2c-a69a-4607-b59e-ac957720189d",
            "port": "constant-out"
          },
          "target": {
            "block": "60d4c187-7512-41f9-bec7-85e3cc3264cb",
            "port": "INI"
          },
          "vertices": []
        },
