{
  "version": "1.2",
  "package": {
    "name": "SregR-02-verilog",
    "version": "0.2",
    "description": "SregR-02-verilog: Two bits Shift register to the right. Verilog implementation",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "42c99d6d-c143-4ad5-b50e-ebaec64c9bac",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "0",
        ...
        {
          "id": "8f08d0b4-4013-4756-b87b-0973f136908d",
          "type": "basic.code",
          "data": {
            "ports": {
              "in": [
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "8f08d0b4-4013-4756-b87b-0973f136908d",
            "port": "clk"
          }
        },
        {
        ...
        {
          "source": {
            "block": "42c99d6d-c143-4ad5-b50e-ebaec64c9bac",
            "port": "constant-out"
          },
          "target": {
            "block": "8f08d0b4-4013-4756-b87b-0973f136908d",
