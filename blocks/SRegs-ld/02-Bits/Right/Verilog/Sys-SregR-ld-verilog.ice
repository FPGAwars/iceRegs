{
  ...
  "package": {
    ...
    "version": "0.3",
    "description": "Sys-SregR-ld-02-verilog: Two bits System Shift register to the right, with load. Verilog implementation",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "0035b0cb-19b2-4226-ac3f-b9d7f57d29d1",
          "type": "basic.output",
          "data": {
            "name": "nc",
            "virtual": true,
        ...
        {
          "id": "4563e2f9-c0b7-4aee-914a-b568fd5b590b",
          "type": "basic.output",
          "data": {
            "name": "nc",
            "virtual": true,
