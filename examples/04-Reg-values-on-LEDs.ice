{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "5500f1f4-38d3-46a8-8c78-ec2c88186412",
          "type": "ead57b3c25a3627d650bf0edd5a67fd2e932c1b3",
          "position": {
            "x": 712,
            "y": 432
          },
      ...
      "wires": [
        {
          "source": {
            "block": "5500f1f4-38d3-46a8-8c78-ec2c88186412",
            "port": "bd691216-272b-4edc-84c3-d7507fe94d5a"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "5500f1f4-38d3-46a8-8c78-ec2c88186412",
            "port": "830e8e28-42aa-4462-99d2-ecd17e79d5a4"
          },
          "size": 8
        }
      ]
  ...
  "dependencies": {
    ...
    "ead57b3c25a3627d650bf0edd5a67fd2e932c1b3": {
      "package": {
        "name": "Reg-8",
        "version": "0.3",
        "description": "Reg-8: 8 bits Register with load input",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "8393a961-1285-4b3d-96cb-eebd207f7238",
              "type": "basic.outputLabel",
              "data": {
                "name": "data",
                "range": "[7:0]",
            ...
            {
              "id": "5b0470d2-0899-4280-b038-3277a3254723",
              "type": "basic.inputLabel",
              "data": {
                "name": "value",
                "range": "[7:0]",
            ...
            {
              "id": "e5e5d658-3c53-498e-8565-e3b87b0493ae",
              "type": "basic.outputLabel",
              "data": {
                "name": "value",
                "range": "[7:0]",
            ...
            {
              "id": "bd691216-272b-4edc-84c3-d7507fe94d5a",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[7:0]",
            ...
            {
              "id": "61389e2b-1453-4836-b4b5-e58bc62264e4",
              "type": "basic.outputLabel",
              "data": {
                "name": "value",
                "range": "[7:0]",
            ...
            {
              "id": "9c9412d9-39b5-4977-afc9-fb3428d2f555",
              "type": "basic.inputLabel",
              "data": {
                "name": "data",
                "range": "[7:0]",
            ...
            {
              "id": "830e8e28-42aa-4462-99d2-ecd17e79d5a4",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[7:0]",
            ...
            {
              "id": "fffd4e90-928f-4634-a618-ed94b92dc007",
            ...
            {
              "id": "c8477bd6-e18d-4bc4-b169-283a80cdd94a",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "fffd4e90-928f-4634-a618-ed94b92dc007",
                "port": "ca7c5f10-efb6-43f9-9364-52d751fc0bc6"
              }
            },
            {
            ...
            },
            {
              ...
              "target": {
                "block": "c8477bd6-e18d-4bc4-b169-283a80cdd94a",
                "port": "1e7e3cd6-ed00-468a-9f7c-0bb91e020dce"
              }
            },
            {
              "source": {
                "block": "61389e2b-1453-4836-b4b5-e58bc62264e4",
                "port": "outlabel"
              },
              "target": {
                "block": "bd691216-272b-4edc-84c3-d7507fe94d5a",
                "port": "in",
                "size": 8
              },
              "size": 8
            },
            {
              ...
              "target": {
                "block": "5b0470d2-0899-4280-b038-3277a3254723",
                "port": "inlabel"
              },
              "size": 8
            },
            {
              "source": {
                "block": "e5e5d658-3c53-498e-8565-e3b87b0493ae",
                "port": "outlabel"
              },
              "target": {
                "block": "c8477bd6-e18d-4bc4-b169-283a80cdd94a",
            ...
            {
              "source": {
                "block": "8393a961-1285-4b3d-96cb-eebd207f7238",
                "port": "outlabel"
              },
              "target": {
                "block": "c8477bd6-e18d-4bc4-b169-283a80cdd94a",
            ...
            {
              "source": {
                "block": "830e8e28-42aa-4462-99d2-ecd17e79d5a4",
                "port": "out",
                "size": 8
              },
              "target": {
                "block": "9c9412d9-39b5-4977-afc9-fb3428d2f555",
                "port": "inlabel"
              },
              "size": 8
            },
