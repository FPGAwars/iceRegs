{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 14-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 456,
        ...
        {
          "id": "a21519d3-d38e-4a68-87a2-14bf5c338e42",
        ...
        {
          "id": "336fb320-1538-4c58-a2c0-896ec578073c",
          "type": "178c1268b75d0a3faa237a29dee3a17fae4e3363",
          "position": {
            "x": 912,
            "y": 416
          },
        ...
        {
          "id": "a5c85ba8-97c2-40f1-9b92-18160407edc5",
          "type": "15c3a32cfb75ff708297fd3af59694e7b814e115",
          "position": {
            "x": 680,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "a5c85ba8-97c2-40f1-9b92-18160407edc5",
        ...
        },
        {
          ...
          "target": {
            "block": "a21519d3-d38e-4a68-87a2-14bf5c338e42",
        ...
        {
          "source": {
            "block": "336fb320-1538-4c58-a2c0-896ec578073c",
        ...
        },
        {
          ...
          "target": {
            "block": "a5c85ba8-97c2-40f1-9b92-18160407edc5",
            "port": "b84efc2e-cc60-46d4-ad10-14f8626b7bd1"
          },
          "size": 14
        },
        {
          "source": {
            "block": "a5c85ba8-97c2-40f1-9b92-18160407edc5",
            "port": "1f38bc52-1acc-4f0a-a063-20a1a33834aa"
          },
          "target": {
            "block": "336fb320-1538-4c58-a2c0-896ec578073c",
            "port": "1d487f34-e8d7-4c14-8170-0714857c7dc7"
          },
          "size": 14
        }
      ]
  ...
  "dependencies": {
    ...
    "178c1268b75d0a3faa237a29dee3a17fae4e3363": {
      "package": {
        "name": "UINT16-14bits",
        "version": "0.1",
        "description": "UINT16-14bits:  Extend a 14-bits unsigned integer to 16-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "1d487f34-e8d7-4c14-8170-0714857c7dc7",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[13:0]",
            ...
            {
              "id": "fec52301-3c41-487e-99f2-6058767c995a",
              "type": "ad2655f18fa14774dcfb913dc036d30fd36bfbc0",
              "position": {
                "x": 792,
                "y": 360
              },
            ...
            {
              "id": "68711de5-8ea9-448b-b67f-3a80061d59b0",
          ...
          "wires": [
            {
              "source": {
                "block": "68711de5-8ea9-448b-b67f-3a80061d59b0",
                "port": "6a253ddf-22b2-43cd-ba6f-561bd1af6970"
              },
              "target": {
                "block": "fec52301-3c41-487e-99f2-6058767c995a",
                "port": "04efc8dc-df6a-48bb-9198-f2017d2a2123"
              },
              "vertices": [
                {
                  "x": 744,
            ...
            {
              "source": {
                "block": "1d487f34-e8d7-4c14-8170-0714857c7dc7",
                "port": "out"
              },
              "target": {
                "block": "fec52301-3c41-487e-99f2-6058767c995a",
                "port": "fc22bd61-f3a6-45a1-8416-fbc8a9427a97"
              },
              "size": 14
            }
          ]
    ...
    "ad2655f18fa14774dcfb913dc036d30fd36bfbc0": {
      "package": {
        "name": "Bus16-Join-2-14",
        "version": "0.1",
        "description": "Bus16-Join-2-14: Join the two buses into a 16-bits Bus",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M164.218%2077.643L103.07%2016.705C92.386%206.25%2078.036.461%2063.11.5H.5v26.186l61.698.046c8.012-.043%2015.705%203.133%2021.47%208.81l61.448%2061.315a57.292%2057.292%200%200%200%2039.993%2016.139%2057.292%2057.292%200%200%200-39.993%2016.14L83.668%20190.45c-5.765%205.677-13.458%208.853-21.47%208.81L.5%20199.306v26.186h62.612c14.924.039%2029.463-5.9%2040.204-16.28l60.902-60.863a29.857%2029.857%200%200%201%2021.347-8.81l146.53-.113V86.457H185.571a29.884%2029.884%200%200%201-21.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "04efc8dc-df6a-48bb-9198-f2017d2a2123",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[1:0]",
            ...
            {
              "id": "fc22bd61-f3a6-45a1-8416-fbc8a9427a97",
              "type": "basic.input",
              "data": {
                "name": "0",
                "range": "[13:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "fc22bd61-f3a6-45a1-8416-fbc8a9427a97",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            {
              "source": {
                "block": "04efc8dc-df6a-48bb-9198-f2017d2a2123",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
    ...
    "15c3a32cfb75ff708297fd3af59694e7b814e115": {
      "package": {
        "name": "Reg-rst-14-verilog",
        "version": "0.3",
        "description": "Reg-rst-14-verilog: 14-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "1f38bc52-1acc-4f0a-a063-20a1a33834aa",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "b84efc2e-cc60-46d4-ad10-14f8626b7bd1",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "b84efc2e-cc60-46d4-ad10-14f8626b7bd1",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
            ...
            },
            {
              ...
              "target": {
                "block": "1f38bc52-1acc-4f0a-a063-20a1a33834aa",
                "port": "in"
              },
              "size": 14
            }
