{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 8-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 312,
        ...
        {
          "id": "d91ff909-dd77-48e6-b604-cf922974f937",
        ...
        {
          "id": "2880e998-6894-485c-8b60-da83b3a37ed5",
          "type": "46856560d5cbe84275cc167dfd0baebb23921f09",
          "position": {
            "x": 680,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "2880e998-6894-485c-8b60-da83b3a37ed5",
        ...
        },
        {
          ...
          "target": {
            "block": "d91ff909-dd77-48e6-b604-cf922974f937",
        ...
        },
        {
          ...
          "target": {
            "block": "2880e998-6894-485c-8b60-da83b3a37ed5",
            "port": "3d9b5069-0fd4-4057-8f39-1498ed9ba707"
          },
          "size": 8
        },
        {
          "source": {
            "block": "2880e998-6894-485c-8b60-da83b3a37ed5",
            "port": "60bd6fc6-159f-4ede-bbb0-63fe0e5b6565"
          },
          "target": {
  ...
  "dependencies": {
    ...
    "46856560d5cbe84275cc167dfd0baebb23921f09": {
      "package": {
        "name": "Reg-rst-8",
        "version": "0.3",
        "description": "Reg-rst-8: 8 bits Register with load and reset inputs",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "e6e461e9-0f2f-409f-97d0-46a263ce1cb0",
              "type": "basic.outputLabel",
              "data": {
                "name": "data",
                "range": "[7:0]",
            ...
            {
              "id": "0be22c1d-2929-4568-8af3-af997d25bc6b",
              "type": "basic.inputLabel",
              "data": {
                "name": "value",
                "range": "[7:0]",
            ...
            {
              "id": "9b6de871-86e6-4712-93ab-fd06079288c7",
              "type": "basic.outputLabel",
              "data": {
                "name": "value",
                "range": "[7:0]",
            ...
            {
              "id": "60bd6fc6-159f-4ede-bbb0-63fe0e5b6565",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "233774ee-eccd-4b50-a261-86c748072094",
              "type": "basic.outputLabel",
              "data": {
                "name": "value",
                "range": "[7:0]",
            ...
            {
              "id": "041452bb-9435-48db-821b-c879d69ee1c8",
              "type": "basic.inputLabel",
              "data": {
                "name": "data",
                "range": "[7:0]",
            ...
            {
              "id": "3d9b5069-0fd4-4057-8f39-1498ed9ba707",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "eef51c83-7017-4b49-a41d-b45f168909f0",
            ...
            {
              "id": "4001c918-f500-4344-a787-01a21bc260ba",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "4001c918-f500-4344-a787-01a21bc260ba",
            ...
            },
            {
              ...
              "target": {
                "block": "eef51c83-7017-4b49-a41d-b45f168909f0",
            ...
            },
            {
              "source": {
                "block": "4001c918-f500-4344-a787-01a21bc260ba",
                "port": "6f3d29f2-1f09-45c3-abae-b85e3fbc0c61"
              },
              "target": {
                "block": "0be22c1d-2929-4568-8af3-af997d25bc6b",
                "port": "inlabel"
              },
              "size": 8
            },
            {
              "source": {
                "block": "9b6de871-86e6-4712-93ab-fd06079288c7",
                "port": "outlabel"
              },
              "target": {
                "block": "60bd6fc6-159f-4ede-bbb0-63fe0e5b6565",
                "port": "in"
              },
              "size": 8
            },
            {
              "source": {
                "block": "233774ee-eccd-4b50-a261-86c748072094",
                "port": "outlabel"
              },
              "target": {
                "block": "eef51c83-7017-4b49-a41d-b45f168909f0",
            ...
            {
              "source": {
                "block": "e6e461e9-0f2f-409f-97d0-46a263ce1cb0",
                "port": "outlabel"
              },
              "target": {
                "block": "eef51c83-7017-4b49-a41d-b45f168909f0",
            ...
            {
              "source": {
                "block": "3d9b5069-0fd4-4057-8f39-1498ed9ba707",
                "port": "out"
              },
              "target": {
                "block": "041452bb-9435-48db-821b-c879d69ee1c8",
                "port": "inlabel"
              },
              "size": 8
            },
            ...
            },
            {
              ...
              "target": {
                "block": "4001c918-f500-4344-a787-01a21bc260ba",
                "port": "ba1bbcd3-4ee6-4eb1-ba99-5b36adc16dea"
              },
              "size": 8
            }
          ]
