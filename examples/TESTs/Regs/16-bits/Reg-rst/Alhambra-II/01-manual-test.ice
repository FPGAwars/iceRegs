{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 16-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 456,
        ...
        {
          "id": "dcdb113b-8e8b-41b5-b326-06e34cd3ee73",
        ...
        {
          "id": "e90ea085-33e4-4533-9b76-b554208434e4",
          "type": "83750f4adb53c25b447c7d56b85d4dd39b3375a7",
          "position": {
            "x": 824,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "e90ea085-33e4-4533-9b76-b554208434e4",
        ...
        },
        {
          ...
          "target": {
            "block": "dcdb113b-8e8b-41b5-b326-06e34cd3ee73",
        ...
        },
        {
          ...
          "target": {
            "block": "e90ea085-33e4-4533-9b76-b554208434e4",
            "port": "249dba7b-23b3-4654-a46c-fe9b168c3220"
          },
          "size": 16
        },
        {
          "source": {
            "block": "e90ea085-33e4-4533-9b76-b554208434e4",
            "port": "67ff94ac-0a69-4a8c-b620-6da6c2957b61"
          },
          "target": {
            "block": "37f1b55a-587e-4dd4-8936-13daddfa140d",
  ...
  "dependencies": {
    ...
    "83750f4adb53c25b447c7d56b85d4dd39b3375a7": {
      "package": {
        "name": "Reg-rst-16",
        "version": "0.3",
        "description": "Reg-rst-16: 16 bits Register with load and reset inputs",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "284926d4-59d8-4978-9c26-bbe5a79882c1",
              "type": "basic.outputLabel",
              "data": {
                "name": "data",
                "range": "[15:0]",
            ...
            {
              "id": "62f7acbb-1a3d-4411-b0ea-6a3f6c192339",
              "type": "basic.inputLabel",
              "data": {
                "name": "value",
                "range": "[15:0]",
            ...
            {
              "id": "1f03a598-2abf-4d05-89ee-9d33efd1da7f",
              "type": "basic.outputLabel",
              "data": {
                "name": "value",
                "range": "[15:0]",
            ...
            {
              "id": "67ff94ac-0a69-4a8c-b620-6da6c2957b61",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "880afea3-ad2b-47db-9298-ff73b73275dc",
              "type": "basic.outputLabel",
              "data": {
                "name": "value",
                "range": "[15:0]",
            ...
            {
              "id": "e5a5becb-35ff-4246-a4b7-cdc25e3eb986",
              "type": "basic.inputLabel",
              "data": {
                "name": "data",
                "range": "[15:0]",
            ...
            {
              "id": "249dba7b-23b3-4654-a46c-fe9b168c3220",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "a8cf120f-f63b-4813-b080-e5ce10d5e040",
            ...
            {
              "id": "3cea6ef3-435b-4a7e-bbdb-966af2e570f2",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "3cea6ef3-435b-4a7e-bbdb-966af2e570f2",
            ...
            },
            {
              ...
              "target": {
                "block": "a8cf120f-f63b-4813-b080-e5ce10d5e040",
            ...
            },
            {
              ...
              "target": {
                "block": "62f7acbb-1a3d-4411-b0ea-6a3f6c192339",
                "port": "inlabel"
              },
              "size": 16
            },
            ...
            {
              "source": {
                "block": "1f03a598-2abf-4d05-89ee-9d33efd1da7f",
                "port": "outlabel"
              },
              "target": {
                "block": "67ff94ac-0a69-4a8c-b620-6da6c2957b61",
                "port": "in"
              },
              "size": 16
            },
            {
              "source": {
                "block": "880afea3-ad2b-47db-9298-ff73b73275dc",
                "port": "outlabel"
              },
              "target": {
                "block": "a8cf120f-f63b-4813-b080-e5ce10d5e040",
            ...
            {
              "source": {
                "block": "284926d4-59d8-4978-9c26-bbe5a79882c1",
                "port": "outlabel"
              },
              "target": {
                "block": "a8cf120f-f63b-4813-b080-e5ce10d5e040",
            ...
            {
              "source": {
                "block": "249dba7b-23b3-4654-a46c-fe9b168c3220",
                "port": "out"
              },
              "target": {
                "block": "e5a5becb-35ff-4246-a4b7-cdc25e3eb986",
                "port": "inlabel"
              },
              "size": 16
            },
