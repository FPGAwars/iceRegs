{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 11-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "d5dde562-a4b3-4cbc-9deb-367c3635772b",
        ...
        {
          "id": "ef8170c8-02d8-4158-8e03-a9f2cbc49fe7",
          "type": "edebcf2ef66478bdf0d00551035f1f82b1d6519d",
          "position": {
            "x": 912,
            "y": 416
          },
        ...
        {
          "id": "3c17ae56-80cd-42b0-a915-752d9c6fa91b",
          "type": "acf05658db4cd48af0d415ee6a0d9d0cacb20509",
          "position": {
            "x": 680,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "3c17ae56-80cd-42b0-a915-752d9c6fa91b",
        ...
        },
        {
          ...
          "target": {
            "block": "d5dde562-a4b3-4cbc-9deb-367c3635772b",
        ...
        {
          "source": {
            "block": "ef8170c8-02d8-4158-8e03-a9f2cbc49fe7",
        ...
        },
        {
          ...
          "target": {
            "block": "3c17ae56-80cd-42b0-a915-752d9c6fa91b",
            "port": "253419eb-8e4c-4e07-a374-86a2fa4f4214"
          },
          "size": 11
        },
        {
          "source": {
            "block": "3c17ae56-80cd-42b0-a915-752d9c6fa91b",
            "port": "e79a109f-2666-43a2-9c02-aa7b0c7d04e0"
          },
          "target": {
            "block": "ef8170c8-02d8-4158-8e03-a9f2cbc49fe7",
            "port": "24f5efa8-8317-45b4-828d-5f0ebb4757e9"
          },
          "size": 11
        }
      ]
  ...
  "dependencies": {
    ...
    "edebcf2ef66478bdf0d00551035f1f82b1d6519d": {
      "package": {
        "name": "UINT16-11bits",
        "version": "0.1",
        "description": "UINT16-11bits:  Extend a 11-bits unsigned integer to 16-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "24f5efa8-8317-45b4-828d-5f0ebb4757e9",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[10:0]",
            ...
            {
              "id": "6725d587-7403-423e-9725-c4f165ad9a57",
              "type": "1f96551e5a4897f82a7b13b33986c0069fb41de6",
              "position": {
                "x": 816,
                "y": 272
              },
            ...
            {
              "id": "36af119c-cf12-47a6-8cb7-32f494aa5143",
          ...
          "wires": [
            {
              "source": {
                "block": "36af119c-cf12-47a6-8cb7-32f494aa5143",
                "port": "98e81f4b-d4eb-46c1-8750-25f681a5f2cf"
              },
              "target": {
                "block": "6725d587-7403-423e-9725-c4f165ad9a57",
                "port": "8be75a60-5284-4df1-aa2a-0688fdc064ce"
              },
              "vertices": [
                {
                  "x": 752,
            ...
            {
              "source": {
                "block": "24f5efa8-8317-45b4-828d-5f0ebb4757e9",
                "port": "out"
              },
              "target": {
                "block": "6725d587-7403-423e-9725-c4f165ad9a57",
                "port": "75599b26-4167-41fd-90db-0b50e5b61988"
              },
              "size": 11
            }
          ]
    ...
    "1f96551e5a4897f82a7b13b33986c0069fb41de6": {
      "package": {
        "name": "Bus16-Join-5-11",
        "version": "0.1",
        "description": "Bus16-Join-5-11: Join the two same halves into an 16-bits Bus",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M164.218%2077.643L103.07%2016.705C92.386%206.25%2078.036.461%2063.11.5H.5v26.186l61.698.046c8.012-.043%2015.705%203.133%2021.47%208.81l61.448%2061.315a57.292%2057.292%200%200%200%2039.993%2016.139%2057.292%2057.292%200%200%200-39.993%2016.14L83.668%20190.45c-5.765%205.677-13.458%208.853-21.47%208.81L.5%20199.306v26.186h62.612c14.924.039%2029.463-5.9%2040.204-16.28l60.902-60.863a29.857%2029.857%200%200%201%2021.347-8.81l146.53-.113V86.457H185.571a29.884%2029.884%200%200%201-21.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "8be75a60-5284-4df1-aa2a-0688fdc064ce",
              "type": "basic.input",
              "data": {
                "name": "1",
                "virtual": true,
            ...
            {
              "id": "75599b26-4167-41fd-90db-0b50e5b61988",
              "type": "basic.input",
              "data": {
                "name": "0",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "75599b26-4167-41fd-90db-0b50e5b61988",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            {
              "source": {
                "block": "8be75a60-5284-4df1-aa2a-0688fdc064ce",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
    ...
    "acf05658db4cd48af0d415ee6a0d9d0cacb20509": {
      "package": {
        "name": "Reg-rst-11-verilog",
        "version": "0.3",
        "description": "Reg-rst-11-verilog: 11-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "e79a109f-2666-43a2-9c02-aa7b0c7d04e0",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "253419eb-8e4c-4e07-a374-86a2fa4f4214",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "253419eb-8e4c-4e07-a374-86a2fa4f4214",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
            ...
            },
            {
              ...
              "target": {
                "block": "e79a109f-2666-43a2-9c02-aa7b0c7d04e0",
                "port": "in"
              },
              "size": 11
            }
