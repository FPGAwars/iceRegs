{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a81803de-df48-48ec-ae1f-ab411383c109",
          "type": "basic.input",
          "data": {
            "name": "button",
            "pins": [
        ...
        {
          "id": "9bd123a1-b8e7-4e58-9b30-bba27d313288",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "9d9a1dae-3c1c-4173-9d91-90766ecc08aa",
          "type": "basic.input",
          "data": {
            "name": "button",
            "pins": [
        ...
        {
          "id": "dee363cb-0441-4394-ac87-4e6138ce3f6e",
        ...
        {
          "id": "1424658d-bf99-4d6a-a5b3-f87564edd009",
        ...
        {
          "id": "746d550c-2999-401a-816a-6b959658e8fa",
          "type": "basic.info",
          "data": {
            "info": "## Example 1: Manual testing with two buttons and one LED\n\nWhen the button SW2 is pressed, the '1' in the Flip-Flop input  \nis captured and shown on the LED. When the SW2 button is pressed,  \nthe Flip-Flop is reset to 0, and the LED turned off",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "37e797d3-7dae-4438-8002-27d1ec10e07e",
      ...
      "wires": [
        {
          "source": {
            "block": "9d9a1dae-3c1c-4173-9d91-90766ecc08aa",
            "port": "out"
          },
          "target": {
            "block": "dee363cb-0441-4394-ac87-4e6138ce3f6e",
            "port": "21bc142d-a93a-430d-b37a-326435def9f9"
          }
        },
        {
          "source": {
            "block": "37e797d3-7dae-4438-8002-27d1ec10e07e",
            "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
          },
          "target": {
            "block": "9bd123a1-b8e7-4e58-9b30-bba27d313288",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "1424658d-bf99-4d6a-a5b3-f87564edd009",
        ...
        {
          "source": {
            "block": "a81803de-df48-48ec-ae1f-ab411383c109",
            "port": "out"
          },
          "target": {
            "block": "37e797d3-7dae-4438-8002-27d1ec10e07e",
