{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 7-bits Sys-reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 328,
        ...
        {
          "id": "098712c2-85d1-4f04-90d8-063aa5d13dbf",
        ...
        {
          "id": "54ca5b84-22e4-49c4-987b-08030ca6435a",
        ...
        {
          "id": "01f959c2-94bf-4419-82a1-217eae5116f8",
          "type": "46deed21a8a6e04d261f315d4ead9c71d7c71a84",
          "position": {
            "x": 592,
            "y": 320
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "01f959c2-94bf-4419-82a1-217eae5116f8",
        ...
        },
        {
          ...
          "target": {
            "block": "54ca5b84-22e4-49c4-987b-08030ca6435a",
        ...
        {
          "source": {
            "block": "098712c2-85d1-4f04-90d8-063aa5d13dbf",
        ...
        },
        {
          ...
          "target": {
            "block": "01f959c2-94bf-4419-82a1-217eae5116f8",
            "port": "9be76726-75d6-4dbe-9763-34291de52c1c"
          },
          "size": 7
        },
        {
          "source": {
            "block": "01f959c2-94bf-4419-82a1-217eae5116f8",
            "port": "20ce5ba3-1b1d-45d6-8256-026c16a06eb0"
          },
          "target": {
            "block": "098712c2-85d1-4f04-90d8-063aa5d13dbf",
  ...
  "dependencies": {
    ...
    "46deed21a8a6e04d261f315d4ead9c71d7c71a84": {
      "package": {
        "name": "Sys-reg-rst-7-verilog",
        "version": "0.3",
        "description": "Sys-reg-rst-7-verilog: 7 bits system register with reset. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "20ce5ba3-1b1d-45d6-8256-026c16a06eb0",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "9be76726-75d6-4dbe-9763-34291de52c1c",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "9be76726-75d6-4dbe-9763-34291de52c1c",
                "port": "out"
              },
              "target": {
                "block": "2cc2ff9d-ebfc-43e2-83d7-5c4a6d8c77e6",
            ...
            },
            {
              ...
              "target": {
                "block": "20ce5ba3-1b1d-45d6-8256-026c16a06eb0",
                "port": "in"
              },
              "size": 7
            }
