{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 12-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "f80c79c3-f06a-403b-8cfe-69869e520829",
        ...
        {
          "id": "f11b8903-dbcb-4d64-9717-6e39a5b973f3",
          "type": "f8b9d0f3ed2a28a1118b4adf9c8d7697600d2493",
          "position": {
            "x": 912,
            "y": 416
          },
        ...
        {
          "id": "906941aa-dbf3-4aea-9726-6f29a6866dd7",
          "type": "dda2dc4737239380ccc6e514f413a6150477fc67",
          "position": {
            "x": 680,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "906941aa-dbf3-4aea-9726-6f29a6866dd7",
        ...
        },
        {
          ...
          "target": {
            "block": "f80c79c3-f06a-403b-8cfe-69869e520829",
        ...
        {
          "source": {
            "block": "f11b8903-dbcb-4d64-9717-6e39a5b973f3",
        ...
        },
        {
          ...
          "target": {
            "block": "906941aa-dbf3-4aea-9726-6f29a6866dd7",
            "port": "61615802-8292-44aa-8c82-0ec5aa54f6f5"
          },
          "size": 12
        },
        {
          "source": {
            "block": "906941aa-dbf3-4aea-9726-6f29a6866dd7",
            "port": "e55e5e3d-a56e-4513-adba-10bfe9ff85d5"
          },
          "target": {
            "block": "f11b8903-dbcb-4d64-9717-6e39a5b973f3",
            "port": "2ae15ed8-11de-461e-be97-e2a7443afc3f"
          },
          "size": 12
        }
      ]
  ...
  "dependencies": {
    ...
    "f8b9d0f3ed2a28a1118b4adf9c8d7697600d2493": {
      "package": {
        "name": "UINT16-12bits",
        "version": "0.1",
        "description": "UINT16-12bits:  Extend a 12-bits unsigned integer to 16-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "2ae15ed8-11de-461e-be97-e2a7443afc3f",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[11:0]",
            ...
            {
              "id": "05a66613-8fbb-4b8f-8ecc-2981f920d0bc",
              "type": "68058df391101d8a9a82a91329398b4e12c91dca",
              "position": {
                "x": 776,
                "y": 360
              },
            ...
            {
              "id": "634477cc-394f-4cbc-9dd1-cdfddf72cdcb",
          ...
          "wires": [
            {
              "source": {
                "block": "05a66613-8fbb-4b8f-8ecc-2981f920d0bc",
                "port": "79c56f9a-597f-491e-b1d1-d321f63303c2"
              },
              "target": {
            ...
            {
              "source": {
                "block": "2ae15ed8-11de-461e-be97-e2a7443afc3f",
                "port": "out"
              },
              "target": {
                "block": "05a66613-8fbb-4b8f-8ecc-2981f920d0bc",
                "port": "1b3bc2b0-8d3f-4243-9e33-9f070b0ecf2f"
              },
              "size": 12
            },
            {
              "source": {
                "block": "634477cc-394f-4cbc-9dd1-cdfddf72cdcb",
                "port": "bc11ba08-38a3-4e7a-a9c6-1ffd587e89f0"
              },
              "target": {
                "block": "05a66613-8fbb-4b8f-8ecc-2981f920d0bc",
                "port": "db3acb5d-631f-4071-ae42-62c1bc7308ea"
              },
              "size": 4
            }
          ]
    ...
    "68058df391101d8a9a82a91329398b4e12c91dca": {
      "package": {
    ...
    "dda2dc4737239380ccc6e514f413a6150477fc67": {
      "package": {
        "name": "Reg-rst-12-verilog",
        "version": "0.3",
        "description": "Reg-rst-12-verilog: 12-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "e55e5e3d-a56e-4513-adba-10bfe9ff85d5",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "61615802-8292-44aa-8c82-0ec5aa54f6f5",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "61615802-8292-44aa-8c82-0ec5aa54f6f5",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
            ...
            },
            {
              ...
              "target": {
                "block": "e55e5e3d-a56e-4513-adba-10bfe9ff85d5",
                "port": "in"
              },
              "size": 12
            }
