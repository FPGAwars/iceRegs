{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 13-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "7ed9dccb-8c66-49c8-8939-a5df1dbd6f1c",
        ...
        {
          "id": "32e46774-b7bb-4309-8aba-f1b830c34371",
          "type": "629bf49a721935c326cded0c55a73f03d153f05d",
          "position": {
            "x": 912,
            "y": 416
          },
        ...
        {
          "id": "845eff57-8dd4-4851-9e76-95293d2c2e98",
          "type": "b5087201e90ac1514377d8066566086f970fd22f",
          "position": {
            "x": 680,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "845eff57-8dd4-4851-9e76-95293d2c2e98",
        ...
        },
        {
          ...
          "target": {
            "block": "7ed9dccb-8c66-49c8-8939-a5df1dbd6f1c",
        ...
        {
          "source": {
            "block": "32e46774-b7bb-4309-8aba-f1b830c34371",
        ...
        },
        {
          ...
          "target": {
            "block": "845eff57-8dd4-4851-9e76-95293d2c2e98",
            "port": "2e5a6125-dfcb-470a-ac36-9f3bed8ae50c"
          },
          "size": 13
        },
        {
          "source": {
            "block": "845eff57-8dd4-4851-9e76-95293d2c2e98",
            "port": "d7eac531-4bf5-4db3-860c-4b15e7010b40"
          },
          "target": {
            "block": "32e46774-b7bb-4309-8aba-f1b830c34371",
            "port": "cc908905-dfef-47d0-a271-01cb55d927d2"
          },
          "size": 13
        }
      ]
  ...
  "dependencies": {
    ...
    "629bf49a721935c326cded0c55a73f03d153f05d": {
      "package": {
        "name": "UINT16-12bits",
        "version": "0.1",
        "description": "UINT16-13bits:  Extend a 13-bits unsigned integer to 16-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "cc908905-dfef-47d0-a271-01cb55d927d2",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[12:0]",
            ...
            {
              "id": "64320a82-c0c0-48c4-93b1-7f8b2004846c",
              "type": "8b753305b68f985806b45711ce75da58c00057ed",
              "position": {
                "x": 808,
                "y": 304
              },
            ...
            {
              "id": "d87fc04f-9f6a-4590-a20b-5f868640db21",
          ...
          "wires": [
            {
              "source": {
                "block": "d87fc04f-9f6a-4590-a20b-5f868640db21",
                "port": "c176188b-a7f0-49d2-a549-6d5d429d427b"
              },
              "target": {
                "block": "64320a82-c0c0-48c4-93b1-7f8b2004846c",
                "port": "5105df59-131e-4ff9-a339-11f01311506d"
              },
              "vertices": [
                {
                  "x": 752,
            ...
            {
              "source": {
                "block": "cc908905-dfef-47d0-a271-01cb55d927d2",
                "port": "out"
              },
              "target": {
                "block": "64320a82-c0c0-48c4-93b1-7f8b2004846c",
                "port": "d1497f11-d26c-4323-887f-eec37ab18ae3"
              },
              "size": 13
            }
          ]
    ...
    "8b753305b68f985806b45711ce75da58c00057ed": {
      "package": {
        "name": "Bus16-Join-3-13",
        "version": "0.1",
        "description": "Bus16-Join-3-13: Join the two same halves into an 16-bits Bus",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M164.218%2077.643L103.07%2016.705C92.386%206.25%2078.036.461%2063.11.5H.5v26.186l61.698.046c8.012-.043%2015.705%203.133%2021.47%208.81l61.448%2061.315a57.292%2057.292%200%200%200%2039.993%2016.139%2057.292%2057.292%200%200%200-39.993%2016.14L83.668%20190.45c-5.765%205.677-13.458%208.853-21.47%208.81L.5%20199.306v26.186h62.612c14.924.039%2029.463-5.9%2040.204-16.28l60.902-60.863a29.857%2029.857%200%200%201%2021.347-8.81l146.53-.113V86.457H185.571a29.884%2029.884%200%200%201-21.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "5105df59-131e-4ff9-a339-11f01311506d",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "d1497f11-d26c-4323-887f-eec37ab18ae3",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "5105df59-131e-4ff9-a339-11f01311506d",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            {
              "source": {
                "block": "d1497f11-d26c-4323-887f-eec37ab18ae3",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
    ...
    "b5087201e90ac1514377d8066566086f970fd22f": {
      "package": {
        "name": "Reg-rst-13-verilog",
        "version": "0.3",
        "description": "Reg-rst-13-verilog: 13-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "d7eac531-4bf5-4db3-860c-4b15e7010b40",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "2e5a6125-dfcb-470a-ac36-9f3bed8ae50c",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "2e5a6125-dfcb-470a-ac36-9f3bed8ae50c",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
            ...
            },
            {
              ...
              "target": {
                "block": "d7eac531-4bf5-4db3-860c-4b15e7010b40",
                "port": "in"
              },
              "size": 13
            }
