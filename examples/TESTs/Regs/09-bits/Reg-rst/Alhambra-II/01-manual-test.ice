{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 9-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "8b758c3d-f3e4-4d27-a517-83c777ee9598",
        ...
        {
          "id": "27751705-e923-4f38-93cb-54d97f0d8c52",
          "type": "c3ccc7b7718bacb71f8529734739a439343fbe67",
          "position": {
            "x": 912,
            "y": 416
          },
        ...
        {
          "id": "0313a04c-3a19-4685-a100-ab606b83449c",
          "type": "9e341efe11557d203cce4712604b55394bad1f1a",
          "position": {
            "x": 680,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "0313a04c-3a19-4685-a100-ab606b83449c",
        ...
        },
        {
          ...
          "target": {
            "block": "8b758c3d-f3e4-4d27-a517-83c777ee9598",
        ...
        {
          "source": {
            "block": "27751705-e923-4f38-93cb-54d97f0d8c52",
        ...
        },
        {
          ...
          "target": {
            "block": "0313a04c-3a19-4685-a100-ab606b83449c",
            "port": "07ec58aa-0b44-4eba-b574-1c915cb9c654"
          },
          "size": 9
        },
        {
          "source": {
            "block": "0313a04c-3a19-4685-a100-ab606b83449c",
            "port": "bedcce92-47d3-43c3-9f11-d339a45fd611"
          },
          "target": {
            "block": "27751705-e923-4f38-93cb-54d97f0d8c52",
            "port": "784abbba-b181-4651-be19-7c4e364f648a"
          },
          "size": 9
        }
      ]
  ...
  "dependencies": {
    ...
    "c3ccc7b7718bacb71f8529734739a439343fbe67": {
      "package": {
        "name": "UINT16-9bits",
        "version": "0.1",
        "description": "UINT16-9bits:  Extend a 9-bits unsigned integer to 16-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "784abbba-b181-4651-be19-7c4e364f648a",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[8:0]",
            ...
            {
              "id": "2e62ad0d-c257-4e5e-b451-12b5f1be509a",
            ...
            {
              "id": "1f427fe3-6495-4f3d-9bde-6c4f41e1cdab",
              "type": "625648e815c338f30f93a7cc9fdd30e1689947b5",
              "position": {
                "x": 776,
                "y": 360
              },
          ...
          "wires": [
            {
              "source": {
                "block": "1f427fe3-6495-4f3d-9bde-6c4f41e1cdab",
                "port": "79c56f9a-597f-491e-b1d1-d321f63303c2"
              },
              "target": {
            ...
            {
              "source": {
                "block": "784abbba-b181-4651-be19-7c4e364f648a",
                "port": "out"
              },
              "target": {
                "block": "1f427fe3-6495-4f3d-9bde-6c4f41e1cdab",
                "port": "f3b4cb57-04ba-483d-83d7-e4781520b065"
              },
              "size": 9
            },
            {
              "source": {
                "block": "2e62ad0d-c257-4e5e-b451-12b5f1be509a",
                "port": "f6fbb4f1-1753-4354-a2c5-3299eef878f3"
              },
              "target": {
                "block": "1f427fe3-6495-4f3d-9bde-6c4f41e1cdab",
                "port": "2d894ef4-f35c-4fa6-976f-59b3fd683db9"
              },
              "vertices": [
                {
                  "x": 704,
    ...
    "625648e815c338f30f93a7cc9fdd30e1689947b5": {
      "package": {
        "name": "Bus16-Join-7-9",
        "version": "0.1",
        "description": "Bus16-Join-7-9: Join the two same halves into an 16-bits Bus",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M164.218%2077.643L103.07%2016.705C92.386%206.25%2078.036.461%2063.11.5H.5v26.186l61.698.046c8.012-.043%2015.705%203.133%2021.47%208.81l61.448%2061.315a57.292%2057.292%200%200%200%2039.993%2016.139%2057.292%2057.292%200%200%200-39.993%2016.14L83.668%20190.45c-5.765%205.677-13.458%208.853-21.47%208.81L.5%20199.306v26.186h62.612c14.924.039%2029.463-5.9%2040.204-16.28l60.902-60.863a29.857%2029.857%200%200%201%2021.347-8.81l146.53-.113V86.457H185.571a29.884%2029.884%200%200%201-21.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "2d894ef4-f35c-4fa6-976f-59b3fd683db9",
              "type": "basic.input",
              "data": {
                "name": "1",
                "range": "[6:0]",
            ...
            {
              "id": "f3b4cb57-04ba-483d-83d7-e4781520b065",
              "type": "basic.input",
              "data": {
                "name": "0",
                "range": "[8:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "2d894ef4-f35c-4fa6-976f-59b3fd683db9",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            {
              "source": {
                "block": "f3b4cb57-04ba-483d-83d7-e4781520b065",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
    ...
    "9e341efe11557d203cce4712604b55394bad1f1a": {
      "package": {
        "name": "Reg-rst-9-verilog",
        "version": "0.3",
        "description": "Reg-rst-9-verilog: 9-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "bedcce92-47d3-43c3-9f11-d339a45fd611",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "07ec58aa-0b44-4eba-b574-1c915cb9c654",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "07ec58aa-0b44-4eba-b574-1c915cb9c654",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
            ...
            },
            {
              ...
              "target": {
                "block": "bedcce92-47d3-43c3-9f11-d339a45fd611",
                "port": "in"
              },
              "size": 9
            }
