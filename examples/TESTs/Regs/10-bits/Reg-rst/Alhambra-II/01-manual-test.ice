{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 10-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "37f1b55a-587e-4dd4-8936-13daddfa140d",
        ...
        {
          "id": "42ff9f11-378a-46ff-95d6-7127fd009f75",
        ...
        {
          "id": "4a3c7e52-c9c2-4f57-a310-8f9a90562692",
          "type": "25aa314fe61eb67bf065cac98a7d5bd0432ba920",
          "position": {
            "x": 912,
            "y": 416
          },
        ...
        {
          "id": "c3bb91f1-fe5b-4d97-bf54-464d168e9ed2",
          "type": "5d6fe7bbc5119aa5806aae34a11d60bea30ed635",
          "position": {
            "x": 680,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "c3bb91f1-fe5b-4d97-bf54-464d168e9ed2",
        ...
        },
        {
          ...
          "target": {
            "block": "42ff9f11-378a-46ff-95d6-7127fd009f75",
        ...
        {
          "source": {
            "block": "37f1b55a-587e-4dd4-8936-13daddfa140d",
        ...
        {
          "source": {
            "block": "4a3c7e52-c9c2-4f57-a310-8f9a90562692",
            "port": "f63244d4-cc1b-48fa-bb3b-d36704bb0fc2"
          },
          "target": {
            "block": "37f1b55a-587e-4dd4-8936-13daddfa140d",
        ...
        },
        {
          ...
          "target": {
            "block": "c3bb91f1-fe5b-4d97-bf54-464d168e9ed2",
            "port": "c8a915d7-0163-49a8-b095-875562303d41"
          },
          "size": 10
        },
        {
          "source": {
            "block": "c3bb91f1-fe5b-4d97-bf54-464d168e9ed2",
            "port": "66ecf666-024a-41ca-bcb7-9155614e8e9e"
          },
          "target": {
            "block": "4a3c7e52-c9c2-4f57-a310-8f9a90562692",
            "port": "3ab66fef-3573-4658-91c7-9b2c44a8eb5c"
          },
          "size": 10
        }
      ]
  ...
  "dependencies": {
    ...
    "25aa314fe61eb67bf065cac98a7d5bd0432ba920": {
      "package": {
        "name": "UINT16-10bits",
        "version": "0.1",
        "description": "UINT16-10bits:  Extend a 10-bits unsigned integer to 16-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "f63244d4-cc1b-48fa-bb3b-d36704bb0fc2",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[15:0]",
            ...
            {
              "id": "3ab66fef-3573-4658-91c7-9b2c44a8eb5c",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[9:0]",
            ...
            {
              "id": "c82ce8aa-482d-481b-971c-2fae6c1a924d",
            ...
            {
              "id": "626e1f5e-6fbe-4577-b514-1e8a1ecc0a56",
              "type": "cf513d948de92b91230a00f6f69bc67e5a8267f4",
              "position": {
                "x": 824,
                "y": 272
              },
          ...
          "wires": [
            {
              "source": {
                "block": "c82ce8aa-482d-481b-971c-2fae6c1a924d",
                "port": "d52cf263-00e9-4791-8206-8118f63755aa"
              },
              "target": {
                "block": "626e1f5e-6fbe-4577-b514-1e8a1ecc0a56",
                "port": "14aa53fb-a1a9-4fb3-90e0-c4d4ecb442e1"
              },
              "vertices": [],
              "size": 6
            },
            {
              ...
              "target": {
                "block": "f63244d4-cc1b-48fa-bb3b-d36704bb0fc2",
                "port": "in"
              },
              "size": 16
            },
            {
              "source": {
                "block": "3ab66fef-3573-4658-91c7-9b2c44a8eb5c",
                "port": "out"
              },
              "target": {
                "block": "626e1f5e-6fbe-4577-b514-1e8a1ecc0a56",
                "port": "3604a044-92fc-4a7f-8116-1581aa96e8f9"
              },
              "size": 10
            }
          ]
    ...
    "cf513d948de92b91230a00f6f69bc67e5a8267f4": {
      "package": {
        "name": "Bus16-Join-6-10",
        "version": "0.1",
        "description": "Bus16-Join-6-10: Join the two same halves into an 16-bits Bus",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M164.218%2077.643L103.07%2016.705C92.386%206.25%2078.036.461%2063.11.5H.5v26.186l61.698.046c8.012-.043%2015.705%203.133%2021.47%208.81l61.448%2061.315a57.292%2057.292%200%200%200%2039.993%2016.139%2057.292%2057.292%200%200%200-39.993%2016.14L83.668%20190.45c-5.765%205.677-13.458%208.853-21.47%208.81L.5%20199.306v26.186h62.612c14.924.039%2029.463-5.9%2040.204-16.28l60.902-60.863a29.857%2029.857%200%200%201%2021.347-8.81l146.53-.113V86.457H185.571a29.884%2029.884%200%200%201-21.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "14aa53fb-a1a9-4fb3-90e0-c4d4ecb442e1",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "3604a044-92fc-4a7f-8116-1581aa96e8f9",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "14aa53fb-a1a9-4fb3-90e0-c4d4ecb442e1",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            {
              "source": {
                "block": "3604a044-92fc-4a7f-8116-1581aa96e8f9",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
    ...
    "5d6fe7bbc5119aa5806aae34a11d60bea30ed635": {
      "package": {
        "name": "Reg-rst-10-verilog",
        "version": "0.3",
        "description": "Reg-rst-10-verilog: 10-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "66ecf666-024a-41ca-bcb7-9155614e8e9e",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "c8a915d7-0163-49a8-b095-875562303d41",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "c8a915d7-0163-49a8-b095-875562303d41",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
            ...
            },
            {
              ...
              "target": {
                "block": "66ecf666-024a-41ca-bcb7-9155614e8e9e",
                "port": "in"
              },
              "size": 10
            }
