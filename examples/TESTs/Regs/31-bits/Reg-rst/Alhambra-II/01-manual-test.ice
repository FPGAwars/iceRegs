{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 31-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 456,
        ...
        {
          "id": "fccf8aa3-aca6-48e0-9580-9f80d75367e2",
          "type": "e9d855d7f134ca38e5d5636fc1fa2e51c196af4e",
          "position": {
            "x": 920,
            "y": 416
          },
        ...
        {
          "id": "fe15cf08-5b66-4472-9d4b-7bcfb8a2392b",
          "type": "9e8a0370fb4c9bef1d97990c680128510024f093",
          "position": {
            "x": 720,
            "y": 368
          },
        ...
        {
          "id": "251563fa-aa91-4835-a2e3-07cf9a125501",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "fe15cf08-5b66-4472-9d4b-7bcfb8a2392b",
        ...
        },
        {
          ...
          "target": {
            "block": "251563fa-aa91-4835-a2e3-07cf9a125501",
        ...
        {
          "source": {
            "block": "fccf8aa3-aca6-48e0-9580-9f80d75367e2",
        ...
        },
        {
          "source": {
            "block": "fe15cf08-5b66-4472-9d4b-7bcfb8a2392b",
            "port": "80d29faa-092f-4208-9e58-54c3562cf68b"
          },
          "target": {
            "block": "fccf8aa3-aca6-48e0-9580-9f80d75367e2",
            "port": "f0e08613-5b90-441c-b244-576bb02ed7ec"
          },
          "size": 31
        },
        {
          ...
          "target": {
            "block": "fe15cf08-5b66-4472-9d4b-7bcfb8a2392b",
            "port": "f2f84d27-1a9c-40d6-926f-e08b29e8fd43"
          },
          "size": 31
        }
      ]
  ...
  "dependencies": {
    ...
    "e9d855d7f134ca38e5d5636fc1fa2e51c196af4e": {
      "package": {
        "name": "UINT32-31bits",
        "version": "0.1",
        "description": "UINT32-31bits:  Extend a 31-bits unsigned integer to 32-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "f0e08613-5b90-441c-b244-576bb02ed7ec",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[30:0]",
            ...
            {
              "id": "69c19562-c0bb-47ae-8745-0f5e811e9876",
              "type": "d30ca9ee4f35f6cb76d5e5701447fc2b739bc640",
              "position": {
                "x": 648,
                "y": 224
            ...
            {
              "id": "ce72a539-a9fd-4806-ab2d-111ae9f94d30",
          ...
          "wires": [
            {
              "source": {
                "block": "69c19562-c0bb-47ae-8745-0f5e811e9876",
                "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
              },
              "target": {
                "block": "ce72a539-a9fd-4806-ab2d-111ae9f94d30",
            ...
            {
              "source": {
                "block": "f0e08613-5b90-441c-b244-576bb02ed7ec",
                "port": "out"
              },
              "target": {
                "block": "ce72a539-a9fd-4806-ab2d-111ae9f94d30",
    ...
    "9e8a0370fb4c9bef1d97990c680128510024f093": {
      "package": {
        "name": "Reg-rst-31-verilog",
        "version": "0.3",
        "description": "Reg-rst-31-verilog: 31-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22286.865%22%20height=%22270.812%22%20viewBox=%220%200%2075.899794%2071.65232%22%3E%3Cpath%20d=%22M43.907%2033.607h10.645%22%20color=%22#000%22%20fill=%22#00f%22/%3E%3Cg%20stroke=%22#000%22%20stroke-width=%221.442%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22%3E%3Cpath%20d=%22M102.876%20163.95l4.552%2028.037%205.644-28.037%22%20fill=%22#ccc%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-85.712%20-27.533)%22/%3E%3Cpath%20d=%22M99.758%20149.859l2.39-28.512h-9.831v-5.462h31.86v5.462h-9.284l1.724%2028.769s7.509%201.248%209.269%206.48c1.76%205.231-.367%207.286.15%207.36l-36.077-.044s-.817-6.104%202.015-9.194c2.832-3.09%207.784-4.86%207.784-4.86z%22%20fill=%22red%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-85.712%20-27.533)%22/%3E%3C/g%3E%3Cg%20stroke=%22#000%22%20stroke-width=%221.442%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22%3E%3Cpath%20d=%22M102.876%20163.95l4.552%2028.037%205.644-28.037%22%20fill=%22#ccc%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-69.38%20-28.47)%22/%3E%3Cpath%20d=%22M99.758%20149.859l2.39-28.512h-9.831v-5.462h31.86v5.462h-9.284l1.724%2028.769s7.509%201.248%209.269%206.48c1.76%205.231-.367%207.286.15%207.36l-36.077-.044s-.817-6.104%202.015-9.194c2.832-3.09%207.784-4.86%207.784-4.86z%22%20fill=%22red%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-69.38%20-28.47)%22/%3E%3C/g%3E%3Cg%20transform=%22translate(-93.518%20-25.072)%20scale(1.09073)%22%20stroke=%22green%22%20stroke-linecap=%22round%22%3E%3Ccircle%20cx=%22100.602%22%20cy=%2273.815%22%20r=%2214.559%22%20fill=%22#ececec%22%20stroke-width=%22.608%22%20stroke-linejoin=%22round%22/%3E%3Cpath%20d=%22M106.978%2082.142h-3.353V63.316H97.54v18.678h-3.652%22%20fill=%22none%22%20stroke-width=%221.521%22/%3E%3C/g%3E%3C/svg%3E",
        "otid": 1618509859237
      },
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "80d29faa-092f-4208-9e58-54c3562cf68b",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "f2f84d27-1a9c-40d6-926f-e08b29e8fd43",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "80d29faa-092f-4208-9e58-54c3562cf68b",
                "port": "in"
              },
              "size": 31
            },
            {
              "source": {
                "block": "f2f84d27-1a9c-40d6-926f-e08b29e8fd43",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
