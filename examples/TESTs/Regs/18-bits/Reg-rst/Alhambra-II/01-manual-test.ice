{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST: 18-bits Reg-rst: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 456,
        ...
        {
          "id": "73ba598a-9568-43c7-99d4-4bb7c43063fe",
        ...
        {
          "id": "4522c711-5a64-4095-87c8-b9ea9976062c",
          "type": "ad6f2142248acd6de489ff80b490656d12f2fc95",
          "position": {
            "x": 920,
            "y": 416
          },
        ...
        {
          "id": "63f01e94-c0aa-47d6-a2e1-2b932957d5a1",
          "type": "ddcdf59d70d73ff6b92bdfeaa25e5a5ad7ba90f4",
          "position": {
            "x": 720,
            "y": 368
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "63f01e94-c0aa-47d6-a2e1-2b932957d5a1",
        ...
        },
        {
          ...
          "target": {
            "block": "73ba598a-9568-43c7-99d4-4bb7c43063fe",
        ...
        {
          "source": {
            "block": "4522c711-5a64-4095-87c8-b9ea9976062c",
        ...
        },
        {
          "source": {
            "block": "73ba598a-9568-43c7-99d4-4bb7c43063fe",
            "port": "dfdf0bd2-b895-489f-87b5-21a1f33a3dd2"
          },
          "target": {
            "block": "63f01e94-c0aa-47d6-a2e1-2b932957d5a1",
            "port": "8f139e66-b3cd-4c19-ba55-40073cc6bc02"
          },
          "size": 18
        },
        {
          "source": {
            "block": "63f01e94-c0aa-47d6-a2e1-2b932957d5a1",
            "port": "8b23a68a-8a2b-4242-9856-7568644aa5e4"
          },
          "target": {
            "block": "4522c711-5a64-4095-87c8-b9ea9976062c",
            "port": "7e83c9fb-cfa1-4e34-acaa-7810512fb2cc"
          },
          "size": 18
        }
      ]
  ...
  "dependencies": {
    ...
    "ad6f2142248acd6de489ff80b490656d12f2fc95": {
      "package": {
        "name": "UINT32-18bits",
        "version": "0.1",
        "description": "UINT32-18bits:  Extend a 18-bits unsigned integer to 32-bits ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "7e83c9fb-cfa1-4e34-acaa-7810512fb2cc",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[17:0]",
            ...
            {
              "id": "40a0bc1c-ae9c-4a89-8425-ab2e4ccf2320",
              "type": "134ed3f6d746e6a7791570d85926f34252f40598",
              "position": {
                "x": 800,
                "y": 360
              },
            ...
            {
              "id": "963c7f23-19ef-44cb-9f19-e7af4dfeda8c",
          ...
          "wires": [
            {
              "source": {
                "block": "963c7f23-19ef-44cb-9f19-e7af4dfeda8c",
                "port": "9a292d4b-866d-4b91-919d-e75f9a0714b9"
              },
              "target": {
                "block": "40a0bc1c-ae9c-4a89-8425-ab2e4ccf2320",
                "port": "377533a0-2f3c-4d71-bef9-b59da56918c0"
              },
              "vertices": [
                {
                  "x": 736,
            ...
            {
              "source": {
                "block": "7e83c9fb-cfa1-4e34-acaa-7810512fb2cc",
                "port": "out"
              },
              "target": {
                "block": "40a0bc1c-ae9c-4a89-8425-ab2e4ccf2320",
                "port": "5e3b5238-8109-47b7-b5c7-ecb071ab94e9"
              },
              "size": 18
            }
          ]
    ...
    "134ed3f6d746e6a7791570d85926f34252f40598": {
      "package": {
        "name": "Bus32-Join-14-18",
        "version": "0.1",
        "description": "Bus32-Join-14-18: Join the two buses into an 32-bits Bus",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M164.218%2077.643L103.07%2016.705C92.386%206.25%2078.036.461%2063.11.5H.5v26.186l61.698.046c8.012-.043%2015.705%203.133%2021.47%208.81l61.448%2061.315a57.292%2057.292%200%200%200%2039.993%2016.139%2057.292%2057.292%200%200%200-39.993%2016.14L83.668%20190.45c-5.765%205.677-13.458%208.853-21.47%208.81L.5%20199.306v26.186h62.612c14.924.039%2029.463-5.9%2040.204-16.28l60.902-60.863a29.857%2029.857%200%200%201%2021.347-8.81l146.53-.113V86.457H185.571a29.884%2029.884%200%200%201-21.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "377533a0-2f3c-4d71-bef9-b59da56918c0",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "5e3b5238-8109-47b7-b5c7-ecb071ab94e9",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "377533a0-2f3c-4d71-bef9-b59da56918c0",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            {
              "source": {
                "block": "5e3b5238-8109-47b7-b5c7-ecb071ab94e9",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
    ...
    "ddcdf59d70d73ff6b92bdfeaa25e5a5ad7ba90f4": {
      "package": {
        "name": "Reg-rst-18-verilog",
        "version": "0.3",
        "description": "Reg-rst-18-verilog: 18-bits Register with load and reset inputs. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22286.865%22%20height=%22270.812%22%20viewBox=%220%200%2075.899794%2071.65232%22%3E%3Cpath%20d=%22M43.907%2033.607h10.645%22%20color=%22#000%22%20fill=%22#00f%22/%3E%3Cg%20stroke=%22#000%22%20stroke-width=%221.442%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22%3E%3Cpath%20d=%22M102.876%20163.95l4.552%2028.037%205.644-28.037%22%20fill=%22#ccc%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-85.712%20-27.533)%22/%3E%3Cpath%20d=%22M99.758%20149.859l2.39-28.512h-9.831v-5.462h31.86v5.462h-9.284l1.724%2028.769s7.509%201.248%209.269%206.48c1.76%205.231-.367%207.286.15%207.36l-36.077-.044s-.817-6.104%202.015-9.194c2.832-3.09%207.784-4.86%207.784-4.86z%22%20fill=%22red%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-85.712%20-27.533)%22/%3E%3C/g%3E%3Cg%20stroke=%22#000%22%20stroke-width=%221.442%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22%3E%3Cpath%20d=%22M102.876%20163.95l4.552%2028.037%205.644-28.037%22%20fill=%22#ccc%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-69.38%20-28.47)%22/%3E%3Cpath%20d=%22M99.758%20149.859l2.39-28.512h-9.831v-5.462h31.86v5.462h-9.284l1.724%2028.769s7.509%201.248%209.269%206.48c1.76%205.231-.367%207.286.15%207.36l-36.077-.044s-.817-6.104%202.015-9.194c2.832-3.09%207.784-4.86%207.784-4.86z%22%20fill=%22red%22%20transform=%22matrix(.65581%20-.3791%20.37863%20.6566%20-69.38%20-28.47)%22/%3E%3C/g%3E%3Cg%20transform=%22translate(-93.518%20-25.072)%20scale(1.09073)%22%20stroke=%22green%22%20stroke-linecap=%22round%22%3E%3Ccircle%20cx=%22100.602%22%20cy=%2273.815%22%20r=%2214.559%22%20fill=%22#ececec%22%20stroke-width=%22.608%22%20stroke-linejoin=%22round%22/%3E%3Cpath%20d=%22M106.978%2082.142h-3.353V63.316H97.54v18.678h-3.652%22%20fill=%22none%22%20stroke-width=%221.521%22/%3E%3C/g%3E%3C/svg%3E",
        "otid": 1618509859237
      },
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "8b23a68a-8a2b-4242-9856-7568644aa5e4",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "8f139e66-b3cd-4c19-ba55-40073cc6bc02",
              "type": "basic.input",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "8f139e66-b3cd-4c19-ba55-40073cc6bc02",
                "port": "out"
              },
              "target": {
                "block": "2947d492-028d-487a-83fa-b2f84a2e2d2f",
            ...
            },
            {
              ...
              "target": {
                "block": "8b23a68a-8a2b-4242-9856-7568644aa5e4",
                "port": "in"
              },
              "size": 18
            }
