{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "73b39f13-278f-4e42-848a-ba7e4dfb6569",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[3:0]",
        ...
        {
          "id": "fabaa656-055a-4005-a9b9-ef60eca7f811",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "'hB",
        ...
        {
          "id": "55ddc932-c4b1-4646-9b77-80c2711d9492",
          "type": "basic.info",
          "data": {
            "info": "# SReg-left-x04: Manual testing",
            "readonly": true
          },
          "position": {
            "x": 736,
        ...
        {
          "id": "c303fdad-e3db-4d1a-99ee-a2827ab35d3b",
          "type": "a136df99b1db01385f61eb68385fbb985ef68f5f",
          "position": {
            "x": 976,
            "y": -272
          },
        ...
        {
          "id": "67c9956a-1efd-4ae9-a20f-5967f28f8679",
        ...
        {
          "id": "462c8716-3cf6-429d-8e56-cafa51a710b6",
      ...
      "wires": [
        {
          "source": {
            "block": "67c9956a-1efd-4ae9-a20f-5967f28f8679",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "c303fdad-e3db-4d1a-99ee-a2827ab35d3b",
            "port": "adf3a6ae-71e2-43dd-b504-c2cdbc14dab7"
          }
        },
        {
          "source": {
            "block": "fabaa656-055a-4005-a9b9-ef60eca7f811",
            "port": "constant-out"
          },
          "target": {
            "block": "c303fdad-e3db-4d1a-99ee-a2827ab35d3b",
            "port": "8cc62e63-6420-48f5-b0ff-cdb03df5ba91"
          }
        },
        {
          "source": {
          ...
          "target": {
            "block": "462c8716-3cf6-429d-8e56-cafa51a710b6",
            "port": "adf3a6ae-71e2-43dd-b504-c2cdbc14dab7"
          }
        },
        {
          ...
          "target": {
            "block": "73b39f13-278f-4e42-848a-ba7e4dfb6569",
            "port": "in"
          },
          "size": 4
        }
  ...
  "dependencies": {
    "a136df99b1db01385f61eb68385fbb985ef68f5f": {
      "package": {
        "name": "Sreg-left-sys-x4",
        "version": "0.1",
        "description": "SReg-left-sys-x4:  Shift register to the left. It shifts the data to the left on every clock cycle",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "fb571726-021a-4050-96bf-826c9fb7beae",
            ...
            {
              "id": "9b1f1bf1-27c2-4e0e-8f8a-8ed47f1c1d45",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "value",
            ...
            {
              "id": "03edffe5-7e78-46cf-9c75-02ef607d9a53",
              "type": "basic.output",
              "data": {
                "name": "q",
                "range": "[3:0]",
            ...
            {
              "id": "23bb5fd0-8a2b-4ee1-be61-dbc2679db9d9",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "value",
            ...
            {
              "id": "c4fb39c3-2d48-4927-92b6-e70dde1f0f06",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "value",
            ...
            {
              "id": "b3016684-d3ea-4780-ad38-e359d6b88466",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "out",
            ...
            {
              "id": "5da5847d-6126-425e-b120-dc1d59666cae",
              "type": "basic.outputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "in",
            ...
            {
              "id": "be053bb4-356b-4695-a8d6-ad97decc71bd",
              "type": "basic.inputLabel",
              "data": {
                "blockColor": "fuchsia",
                "name": "in",
            ...
            {
              "id": "8cc62e63-6420-48f5-b0ff-cdb03df5ba91",
              "type": "basic.constant",
              "data": {
                "name": "",
                "value": "0",
            ...
            {
              "id": "1bb3dd3f-94db-4449-ad60-a815d68201ae",
            ...
            {
              "id": "697090dc-2bdb-41b3-b3e6-eac1f5b03611",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "23bb5fd0-8a2b-4ee1-be61-dbc2679db9d9",
                "port": "outlabel"
              },
              "target": {
                "block": "1bb3dd3f-94db-4449-ad60-a815d68201ae",
            ...
            {
              "source": {
                "block": "697090dc-2bdb-41b3-b3e6-eac1f5b03611",
                "port": "9487b971-dd08-4bd7-86f7-3ab65a68cf4b"
              },
              "target": {
                "block": "c4fb39c3-2d48-4927-92b6-e70dde1f0f06",
                "port": "inlabel"
              },
              "vertices": [],
              "size": 4
            ...
            },
            {
              ...
              "target": {
                "block": "be053bb4-356b-4695-a8d6-ad97decc71bd",
                "port": "inlabel"
              }
            },
            {
              "source": {
                "block": "5da5847d-6126-425e-b120-dc1d59666cae",
                "port": "outlabel"
              },
              "target": {
                "block": "1bb3dd3f-94db-4449-ad60-a815d68201ae",
            ...
            },
            {
              ...
              "target": {
                "block": "b3016684-d3ea-4780-ad38-e359d6b88466",
                "port": "inlabel"
              }
            },
            {
              "source": {
                "block": "fb571726-021a-4050-96bf-826c9fb7beae",
                "port": "outlabel"
              },
              "target": {
            ...
            {
              "source": {
                "block": "9b1f1bf1-27c2-4e0e-8f8a-8ed47f1c1d45",
                "port": "outlabel"
              },
              "target": {
                "block": "03edffe5-7e78-46cf-9c75-02ef607d9a53",
                "port": "in"
              },
              "size": 4
            },
            {
              ...
              "target": {
                "block": "697090dc-2bdb-41b3-b3e6-eac1f5b03611",
                "port": "59048da5-be9d-44c1-ac0d-4a83d254bc7c"
              },
              "vertices": [],
              "size": 4
            },
            {
              "source": {
                "block": "8cc62e63-6420-48f5-b0ff-cdb03df5ba91",
                "port": "constant-out"
              },
              "target": {
                "block": "697090dc-2bdb-41b3-b3e6-eac1f5b03611",
